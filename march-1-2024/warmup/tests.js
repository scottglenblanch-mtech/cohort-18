...
describe('it should handle the undo button', () => {
    it('when clicked once', () => {
        // prep
        // have the user do a turn
        // show there is a circle
        let firstCell = document.querySelector('tr td:first-child')
        const undoButton = document.querySelector('#undo-button')
        firstCell.click();

        let circleElement = firstCell.querySelector(".circle.red")
        
        expect(circleElement).toBeTruthy()
        // click the undo button
        // show there are no circles
        undoButton.click()

        firstCell = document.querySelector('tr td:first-child')
        circleElement = firstCell.querySelector(".circle.red")

        expect(circleElement).not.toBeTruthy()
